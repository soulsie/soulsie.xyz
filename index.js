...
scrollToElement = function(e, style, duration) {
	...
	if(!e) y = 0;
		...
		offset = (e.dataset.scrollOffset ? parseInt(e.dataset.scrollOffset) : 0) * parseFloat(getComputedStyle(document.documentElement)
			.fontSize);
	...
	videoBackground.prototype.autoplay = function() {
		...
		switch(client.os) {
			case 'ios':
				...
				break;
			case 'android':
				if((client.browser == 'chrome' && client.browserVersion >= 54) || (client.browser == 'firefox' && client.browserVersion >= 49))
				return true;
				break;
			default:
				break;
